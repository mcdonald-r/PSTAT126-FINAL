...
# test_model_7 <- lm(log(price) ~ table + x + cut + clarity, data = diamonds_sample)
# summary(test_model_7)

# Using anova decied to go with test_model_4
# anova(test_model_1, test_model_4, test_model_7, test='F')
```

Write the conclusions here.

Comment on Part 2 interesting points. 
