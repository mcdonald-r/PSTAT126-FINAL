...
being 0.8697. At this point I can say that the model has multicollinearity, because of how lowly it originally aligned with 
...
Analyze how it works and what you observe.
...
Document the observations of finding the best model

```{r Part 3.2, echo = T, results = T}
# Give CIs for a mean predicted value and the PIs of a future predicted value for at least one combination of X’s
